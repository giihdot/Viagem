...
function Home() {
  return (
    <>
      ...
      <div className="block">
        <h6> ÍNDIA </h6>
        <p className="parag"> A Índia é um país vasto e diverso, conhecido por sua rica história, cultura vibrante e tradições milenares. <br/>
      ...
      <div className="block">
        <h6> FINLÂNDIA </h6>
        <p className="parag"> A Finlândia é um país nórdico conhecido por sua paisagem deslumbrante, composta por florestas, lagos e o fenômeno da aurora boreal. <br/>
      ...
      <div className="block">
        <h6> EGITO </h6>
        <p className="parag"> O Egito é um país localizado no nordeste da África, famoso por sua rica história e antigas civilizações. <br/>
